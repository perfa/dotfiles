...
(defun color-theme-erik ()
  ...
  (color-theme-install
   '(color-theme-gray30
     ...
     (default ((t (:stipple nil :background "grey20" :foreground "gainsboro" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "outline-courier new"))))
...
(defun color-theme-dexter ()
  "Dexters theme. Based on gray30"
  (interactive)
  (color-theme-install
   '(color-theme-dexter
     ((background-color . "grey20")
     ...
     ((help-highlight-face . underline)
      ...
      (senator-eldoc-use-color . t)
      (widget-mouse-face . highlight))
     (default ((t (:stipple nil :background "grey20" :foreground "beige" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "outline-courier new"))))
     (bg:erc-color-face0 ((t (:background "White"))))
     (bg:erc-color-face1 ((t (:background "black"))))
     (bg:erc-color-face10 ((t (:background "lightblue1"))))
     (bg:erc-color-face11 ((t (:background "cyan"))))
     ...
     (font-lock-constant-face ((t (:foreground "Aquamarine"))))
     (font-lock-function-name-face ((t (:bold t :foreground "DodgerBlue" :weight bold ))))
     (font-lock-keyword-face ((t (:foreground "palevioletred2" ))))
     (font-lock-string-face ((t (:foreground "LightGoldenrod3"))))
     (font-lock-type-face ((t (:foreground "yellow" ))))
     (font-lock-variable-name-face ((t (:foreground "orange1")))) ;;DarkOrange1
     (font-lock-warning-face ((t (:bold t :foreground "Pink" :weight bold))))
     (fringe ((t (:background "grey10"))))
     (header-line ((t (:box (:line-width -1 :style released-button) :background "grey20" :foreground "grey90" :box nil))))
     (highlight ((t (:background "darkolivegreen"))))
     ...
     (menu ((t (nil))))
     (minibuffer-prompt ((t (:foreground "cyan"))))
     (mode-line ((t (:background "grey60" :foreground "black" :box (:line-width -1 :style released-button)))))
     (mode-line-inactive ((t (:background "grey30" :foreground "grey80" :box (:line-width -1 :color "grey40" :style nil) :weight light))))
     (mouse ((t (:background "black"))))
     (primary-selection ((t (:background "gray35"))))
     (region ((t (:background "gray35"))))
     (highlight-beyond-fill-column-face ((t (:background "deep pink" :foreground "white")))  :group 'highlight-current-line)
     (scroll-bar ((t (nil))))
     (secondary-selection ((t (:background "SkyBlue4"))))
     (semantic-dirty-token-face ((t (:background "lightyellow"))))
     (semantic-unmatched-syntax-face ((t (:underline "red"))))
     ...
     (senator-momentary-highlight-face ((t (:background "gray30"))))
     (senator-read-only-face ((t (:background "#664444"))))
     (show-paren-match-face ((t (:background "DarkOrange3" :foreground "white"))))
     (show-paren-mismatch-face ((t (:background "purple" :foreground "white"))))
     (speedbar-button-face ((t (:foreground "green3"))))
     (speedbar-directory-face ((t (:foreground "light blue"))))
     (speedbar-file-face ((t (:foreground "cyan"))))
